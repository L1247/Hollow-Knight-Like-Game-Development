...
namespace Photon.Pun
{
    ...
    public class PhotonTransformViewPositionModel
    {
        ...
        {
            Disabled , FixedSpeed , EstimatedSpeed ,
            SynchronizeValues , Lerp
        }


        public enum ExtrapolateOptions
        {
            Disabled , SynchronizeValues , EstimateSpeedAndTurn ,
            FixedSpeed ,
        }
